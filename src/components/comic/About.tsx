...
export default function About() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{
            ...
            clipPath: STAR,
            opacity: 0.85,
            animation: "spinSlowLocal 18s linear infinite,pulseScale 5s ease-in-out infinite",
          }}
        />
        <div
          style={{
        ...
        <div
          ...
          style={{
            ...
            opacity: 0.04,
            background:
              "repeating-conic-gradient(from 0deg at 50% 50%,var(--ink) 0deg .4deg,transparent .4deg 3.6deg)",
            WebkitMask: "radial-gradient(circle,transparent 6%,#000 28%,transparent 78%)",
            mask: "radial-gradient(circle,transparent 6%,#000 28%,transparent 78%)",
        ...
        <div
          style={{
            ...
            height: "clamp(90px,8.6vw,170px)",
            background: "var(--acc)",
            clipPath: boltPath,
            opacity: 0,
            filter: "drop-shadow(0 0 12px var(--acc))",
            animation: "boltFlash 8s linear infinite",
            animationDelay: "-3s",
          }}
        />
        <span
      ...
      <div
        data-dolly
        style={{ position: "relative", maxWidth: 820, margin: "0 auto", willChange: "transform" }}
      >
        <div
          style={{
            fontFamily: MONO,
        ...
        >
          ...
          >
            ...
            <Reveal
              kind="redact"
              as="span"
              style={redactStyle("background .7s .35s ease,color .5s .6s ease")}
            >
            ...
            <Reveal
              kind="redact"
              as="span"
              style={redactStyle("background .7s .55s ease,color .5s .8s ease")}
            >
          ...
          <div ref={panelRef} style={panelClosedStyle}>
            ...
            >
              ...
              <Reveal
                kind="redact"
                as="span"
                style={redactStyle("background .7s .3s ease,color .5s .55s ease")}
              >
