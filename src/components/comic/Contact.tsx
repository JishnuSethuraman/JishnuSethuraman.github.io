      ...
      >
        <div
          ...
          style={{
            ...
            WebkitMask:
              "radial-gradient(circle at 50% 50%,transparent 5%,#000 26%,#000 55%,transparent 85%)",
            mask: "radial-gradient(circle at 50% 50%,transparent 5%,#000 26%,#000 55%,transparent 85%)",
        ...
        <div
          style={{
            ...
            clipPath: STAR,
            opacity: 0.6,
            animation: "spinSlowLocal 14s linear infinite,pulseScale 4s ease-in-out infinite",
          }}
        />
        <div
          style={{
            ...
            clipPath: STAR,
            opacity: 0.4,
            animation: "spinRevLocal 18s linear infinite",
          }}
        />
        <div
          style={{
      ...
      >
        ...
        >
          <PopLink
            ...
            style={{ color: "#15120c", background: "#f2e8d2", border: "3px solid #f2e8d2" }}
          >
            RESUME
          </PopLink>
          <PopLink
            ...
            style={{ color: "#f2e8d2", background: "transparent", border: "3px solid #f2e8d2" }}
          >
            LINKEDIN
          </PopLink>
          <PopLink
