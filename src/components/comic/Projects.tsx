        ...
        >
          ...
          <div
            ...
            style={{
              ...
              opacity: 0.04,
              background:
                "repeating-conic-gradient(from 0deg at 50% 50%,var(--ink) 0deg .45deg,transparent .45deg 3.2deg)",
              WebkitMask: "radial-gradient(circle,transparent 5%,#000 24%,transparent 74%)",
              mask: "radial-gradient(circle,transparent 5%,#000 24%,transparent 74%)",
          ...
          <span
            style={{
              ...
              animation: "popOccasional 10s ease-in-out infinite",
              animationDelay: "-5s",
            }}
          >
            CASE&nbsp;FILES
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span data-role="fileHud" style={{ color: "var(--acc)" }}>
                  FILE 01 / 08
                </span>{" "}
                · SCROLL TO FLIP THE SHELF
                <br />
