      ...
      >
        ...
        >
          <div
            ...
            style={{
              ...
              WebkitMask:
                "radial-gradient(circle at 50% 50%,transparent 4%,#000 22%,#000 56%,transparent 88%)",
          ...
          <div
            ...
            style={{
              ...
              WebkitMask:
                "radial-gradient(circle at 50% 50%,transparent 6%,#000 30%,transparent 82%)",
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              opacity: 0,
              animation: "ringBurst 3.8s ease-out infinite",
            }}
          />
          <div
            style={{
              ...
              aspectRatio: "1",
              border: "3px solid rgba(21,18,12,.5)",
              borderRadius: "50%",
              opacity: 0,
              animation: "ringBurst 3.8s ease-out infinite",
              animationDelay: "-1.9s",
        ...
        >
          ...
          <div
            style={{
              ...
              clipPath: STAR,
              opacity: 0.82,
              animation: "spinSlowLocal 16s linear infinite,pulseScale 4s ease-in-out infinite",
            }}
          />
          <div
            style={{
          ...
          <span
            style={{
              ...
              animation: "popOccasional 9s ease-in-out infinite",
            }}
          >
            !!
          </span>
        ...
        >
          <div
            style={{
              ...
              height: 28,
              background:
                "repeating-linear-gradient(90deg,#15120c 0 2px,transparent 2px 5px,#15120c 5px 6px,transparent 6px 9px)",
            }}
          />
          <span
            style={{
                ...
                <span style={{ display: "block", overflow: "hidden" }}>
                  <span
                    style={{
                      ...
                      letterSpacing: ".01em",
                      color: "#3a3020",
                      textShadow: ".04em .04em 0 var(--acc)",
              ...
              >
                <div
                  style={{
                    width: "100%",
                    height: "100%",
                    animation: "breathe 8s 1.2s ease-in-out infinite",
                  }}
                >
                  <img
                    src={HEADSHOT}
        ...
        <div
          style={{
            ...
            display: "flex",
            alignItems: "center",
            borderTop: "2px solid rgba(21,18,12,.22)",
            background: "rgba(241,230,203,.55)",
            zIndex: 4,
          }}
        >
          <div
            style={{
              ...
              lineHeight: 1,
              letterSpacing: ".1em",
              color: "rgba(21,18,12,.42)",
              animation: "marquee 32s linear infinite",
            }}
          >
            <span style={{ padding: "0 22px" }}>
              MACHINE&nbsp;LEARNING&nbsp;//&nbsp;LLM&nbsp;PIPELINES&nbsp;//&nbsp;RAG&nbsp;//&nbsp;PYTORCH&nbsp;//&nbsp;MLOps&nbsp;//&nbsp;INFERENCE&nbsp;//&nbsp;DISTILLATION&nbsp;//&nbsp;GANs&nbsp;//&nbsp;TIME-SERIES&nbsp;//&nbsp;
            </span>
            <span style={{ padding: "0 22px" }}>
              MACHINE&nbsp;LEARNING&nbsp;//&nbsp;LLM&nbsp;PIPELINES&nbsp;//&nbsp;RAG&nbsp;//&nbsp;PYTORCH&nbsp;//&nbsp;MLOps&nbsp;//&nbsp;INFERENCE&nbsp;//&nbsp;DISTILLATION&nbsp;//&nbsp;GANs&nbsp;//&nbsp;TIME-SERIES&nbsp;//&nbsp;
            </span>
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              background: "#ffd94a",
              clipPath: "polygon(62% 0,20% 55%,44% 55%,34% 100%,80% 40%,55% 40%)",
              opacity: 0,
              filter: "drop-shadow(0 0 14px rgba(255,217,74,.8))",
          ...
          <div
            style={{
              ...
              animation: "boltFlash 9s linear infinite",
              animationDelay: "-4s",
            }}
          />
          <span
            style={{
              ...
              animation: "popOccasional 7s ease-in-out infinite",
              animationDelay: "-.6s",
            }}
          >
            KRAK!
              ...
              <div style={{ overflow: "hidden" }}>
                ...
                >
                  <span
                    style={{
                      display: "inline-block",
                      animation: "jitter 4s 1.2s ease-in-out infinite",
                    }}
                  >
                    <Letters text="ML/AI" />
                  </span>
              ...
              <div style={{ overflow: "hidden" }}>
                ...
                >
                  <span
                    style={{
                      display: "inline-block",
                      animation: "jitter 5s 1.3s ease-in-out infinite",
                    }}
                  >
        ...
        <div
          style={{
            ...
            display: "flex",
            alignItems: "center",
            borderTop: "2px solid rgba(242,232,210,.18)",
  ...
  return (
    <div
      ...
      style={{
        ...
        opacity: 0,
        visibility: "hidden",
        background: "radial-gradient(120% 120% at 50% 50%,#171208 0%,#0b0804 60%,#050302 100%)",
        overflow: "hidden",
      }}
    >
      <div
        style={{
          ...
          transform: "translate(-50%,-50%)",
          background:
            "repeating-conic-gradient(from 0deg at 50% 50%,var(--acc) 0deg .7deg,transparent .7deg 2.6deg)",
          WebkitMask: "radial-gradient(circle,transparent 7%,#000 30%,#000 62%,transparent 92%)",
          mask: "radial-gradient(circle,transparent 7%,#000 30%,#000 62%,transparent 92%)",
          opacity: 0.5,
      ...
      <div
        style={{
          ...
          transform: "translate(-50%,-50%)",
          background:
            "repeating-conic-gradient(from 0deg at 50% 50%,#f2e8d2 0deg .3deg,transparent .3deg 3.4deg)",
          WebkitMask: "radial-gradient(circle,transparent 10%,#000 36%,transparent 80%)",
          mask: "radial-gradient(circle,transparent 10%,#000 36%,transparent 80%)",
          opacity: 0.28,
      ...
      <div
        style={{
          ...
          transform: "translate(-50%,-50%)",
          background:
            "radial-gradient(circle,color-mix(in srgb,var(--acc) 36%,transparent),transparent 60%)",
          animation: "pulseScaleCentered 5s ease-in-out infinite",
        }}
      />
      <div
        data-role="tunRing"
      ...
      <div
        ...
        style={{
          ...
          aspectRatio: "1",
          marginLeft: "calc(min(46vw,560px) / -2)",
          marginTop: "calc(min(46vw,560px) / -2)",
          zIndex: 2,
          opacity: 0,
        }}
      >
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "radial-gradient(90% 90% at 50% 50%,transparent 55%,rgba(0,0,0,.55))",
          zIndex: 3,
        }}
      />
      <div
        ...
        style={{
          ...
          opacity: 0,
          background:
            "radial-gradient(circle at 50% 50%,#fff,rgba(255,217,74,.8) 45%,transparent 75%)",
          zIndex: 4,
        }}
      />
      <div
      ...
      >
        <div
          style={{
            ...
            padding: "9px 14px",
            transform: "rotate(-2deg)",
            boxShadow: "5px 5px 0 rgba(0,0,0,.6)",
          }}
        >
          ENTERING CHAPTER 01
        </div>
    ...
    <section data-role="heroPin" style={{ position: "relative", width: "100%", height: "380vh" }}>
      ...
      >
        ...
        >
          ...
          />
          WARP&nbsp;DRIVE&nbsp;
          <span data-role="warpPct" style={{ display: "inline-block", width: "4ch" }}>
            0%
          </span>
        </div>
        <div
